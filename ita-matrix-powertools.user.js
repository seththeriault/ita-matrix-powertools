...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return readItinerary; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getCurrentSegs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getTripType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return isOneway; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return isRoundtrip; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return isMulticity; });
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _print_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
function reset() {
  ...
  Object(_print_settings__WEBPACK_IMPORTED_MODULE_1__[/* processPassengers */ "b"])();
}
...
function getAmadeusTriptype() {
  return Object(_parse_itin__WEBPACK_IMPORTED_MODULE_1__[/* getTripType */ "c"])("O", "R", "M");
}
// **** END AMADEUS ****
...
function createUrlContainerInline() {
  const target = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.mcDiv, 1);
  if (!target) return;
...
function createUrlContainer() {
  const target = Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.milagecontainer, 1);
  if (!target) return;
...
/* harmony import */ var _links__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9);
...
function render() {
  // Editor mode?
  if (
    _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enableEditormode == 1 &&
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtargets */ "e"])("editoritem").length === 0
  ) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* toggleVis */ "n"])(document.getElementById("mptStartparse"), "inline-block");
    addEditor();
    return;
  } else if (Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtargets */ "e"])("editoritem").length > 0) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* toggleVis */ "n"])(document.getElementById("mptStartparse"));
    removeEditor();
    Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* readItinerary */ "g"])();
  }

  bindPageLayout();

  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enableFarerules == 1) bindRulelinks();

  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].timeformat == "24h") bind24HourTime();

  if (
    _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].language !== "en" &&
    _settings_translations__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"][_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].language].resultpage !== undefined
  )
    bindTranslations(
      "resultpage",
      _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].language,
      Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.itin, 1).nextElementSibling
    );

  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enablePricebreakdown == 1) bindPriceBreakdown();

  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enableInlineMode == 1) printCPM();

  Object(_links__WEBPACK_IMPORTED_MODULE_5__[/* printLinksContainer */ "a"])();

  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enableSeatguru == 1) bindSeatguru();
  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enablePlanefinder == 1) bindPlanefinder();
  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enableWheretocredit == 1) bindWheretocredit();
}
...
function cleanUp() {
  ...
  //  S&D powertool items
  var elems = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtargets */ "e"])("powertoolsitem");
  for (var i = elems.length - 1; i >= 0; i--) {
    elems[i].parentElement.removeChild(elems[i]);
  }
  // S&D price breakdown
  var pbd = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])("pricebreakdown", 1);
...
function bindPageLayout() {
  Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.milagecontainer, 1).setAttribute(
    "rowspan",
    "10"
  );
  const target = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.htbContainer, 1)
...
function bind24HourTime() {
  ...
  const segs = Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* getCurrentSegs */ "b"])();
  if (segs.length > 0) {
    const target = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.itin, 1)
      .nextElementSibling;
...
function bindRulelinks() {
  ...
  var j = 0;
  var t = 1;
  let target = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.rulescontainer, t);
  if (target != undefined) {
    do {
      var current = Number(
      ...
      i++;
      t++;
      target = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.rulescontainer, t);
...
function bindPriceBreakdown() {
  ...
  var t = 1;
  var target = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.htbLeft, t);
  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enableInlineMode == 0) {
    var output = "";
    var count = 0;
  }
  if (target != undefined) {
    do {
      ...
      if (type == 1) {
        ...
        if (
          Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* hasClass */ "f"])(
            target.nextElementSibling,
            _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.htbGreyBorder
          )
        ) {
          ...
          if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enableInlineMode == 1) {
            ...
            newtr.innerHTML =
              '<td class="' +
              _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.htbLeft +
            ...
            newtr.innerHTML =
              ...
              '%)</div></td><td class="' +
              _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.htbRight +
              '"><div class="gwt-Label">' +
              cur +
              (taxes / 100)
                .toFixed(2)
            ...
            output +=
              ...
              (sum / _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].dist / 100).toFixed(4).toString() +
              "</td></tr>";
            output +=
          ...
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].basefares = +(basefares / 100).toFixed(2);
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].taxes = +(taxes / 100).toFixed(2);
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].surcharges = +(surcharges / 100).toFixed(2);
      ...
      t++;
      target = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.htbLeft, t);
    } while (target != undefined);
  }
  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].enableInlineMode == 0) {
    var printtarget = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.htbContainer, 1)
...
function bindTranslations(page, lang, target) {
  if (_settings_translations__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"][lang] === undefined) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])("Error: Translation " + lang + " not found");
    return false;
  }
  if (_settings_translations__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"][lang][page] === undefined) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])(
      "Error: Translation " + lang + " not found for page " + page
    );
    return false;
  }
  for (let i in _settings_translations__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"][lang][page]) {
    const re = new RegExp(i, "g");
    target.innerHTML = target.innerHTML.replace(
      re,
      _settings_translations__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"][lang][page][i]
    );
  }
}
  ...
  document
    ...
    .insertAdjacentHTML(
      ...
      `<li class="powertoolsitem">${(
        Number(_parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].price) / Number(_parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].dist)
      ).toFixed(4)} cpm</li>`
    );
}
...
function bindSeatguru() {
  for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].itin.length; i++) {
    ...
    for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].itin[i].seg.length; j++) {
      ...
      if (!target) {
        Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])("Error: Could not find target in bindSeatguru");
        return false;
      } else {
        var url =
...
function bindPlanefinder() {
  for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].itin.length; i++) {
    ...
    for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].itin[i].seg.length; j++) {
      ...
      if (!target) {
        Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])("Error: Could not find target in bindPlanefinder");
        return false;
      } else {
        var url =
...
function bindWheretocredit() {
  for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].itin.length; i++) {
    ...
    for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].itin[i].seg.length; j++) {
      ...
      if (!target) {
        Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])("Error: Could not find target in bindWheretocredit");
        return false;
      } else {
        var url =
          "http://www.wheretocredit.com/" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].itin[i].seg[j].carrier.toLowerCase() +
          "/" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* currentItin */ "a"].itin[i].seg[j].bookingclass.toLowerCase();
        target.children[0].classList.add("pt-textlink");
...
function findItinTarget(leg, seg, tcell) {
  var target = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* findtarget */ "d"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.itin, 1);
  if (!target) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])("Error: Itin not found in findItinTarget-function");
    return;
  }
  ...
  if (targetLeg === undefined) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])("Error: Leg not found in findItinTarget-function");
    return;
  }
  ...
  if (targetSeg.length >= 2) {
    ...
    for (i = 0; i < targetSeg.length; i++) {
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* hasClass */ "f"])(targetSeg[i], _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].resultpage.itinRow)) {
        j++;
        if (j >= seg) {
          index = i;
    ...
    switch (tcell) {
      ...
      case "cabin":
        ...
        break;
      default:
        Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])("Error: Unknown Target in findItinTarget-function");
        return;
    }
    return targetSeg[index + rowoffset].children[columnoffset];
  } else {
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* printNotification */ "i"])("Error: Unknown error in findItinTarget-function");
    return;
  }
}
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return createUsersettings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return processPassengers; });
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1);
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
/* harmony import */ var _links__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9);
...
function createUsersettings() {
  ...
  settingscontainer.innerHTML =
    ...
    _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].version +
  ...
  document.getElementById("settingsVisToggler").onclick = function() {
    Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* toggleVis */ "n"])(document.getElementById("mptSettings"));
  };
  document.getElementById("passengerVisToggler").onclick = function() {
    Object(_utils__WEBPACK_IMPORTED_MODULE_3__[/* toggleVis */ "n"])(document.getElementById("mptPassengers"));
  };
  ...
  Object.keys(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"]).forEach(setting => {
    str += `<div id="mpt${setting}" style="width:33%;float:left;">${
      _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"][setting].name
  ...
  document.getElementById("mptStartparse").onclick = function() {
    setTimeout(function() {
      Object(___WEBPACK_IMPORTED_MODULE_4__[/* render */ "b"])();
    }, 50);
  };
  ...
  if (
    ...
    (async () => {
      if (typeof GM === "undefined" || typeof GM.info != "undefined") {
        await Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* saveUserSettings */ "e"])(null);
      }
...
function toggleSettings(target) {
  ...
  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"][target] && _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"][target].values) {
    const pos = findPositionForValue(
      _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"][target],
      _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"][target].values
    );
    if (pos >= _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"][target].values.length - 1 || pos === -1) {
      _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"][target] = _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"][target].values[0].value;
    } else {
      _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"][target] =
        _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"][target].values[pos + 1].value;
    }
  } else {
    switch (target) {
      case "timeformat":
        if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].timeformat == "12h") {
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].timeformat = "24h";
        } else {
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].timeformat = "12h";
        }
        break;
      case "language":
        if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].language == "de") {
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].language = "en";
        } else {
      ...
      case "linkFontsize":
        if (
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].linkFontsize <= 190 &&
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].linkFontsize >= 50
        ) {
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].linkFontsize += 10;
        } else {
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].linkFontsize = 50;
        }
        break;
      case "cabin":
        if (_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin === "Auto") {
          _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin = "Y";
        } else if (_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin === "Y") {
          _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin = "Y+";
        } else if (_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin === "Y+") {
          _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin = "C";
        } else if (_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin === "C") {
          _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin = "F";
        } else if (_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin === "F") {
        ...
        break;
      default:
        if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"][target] == 1) {
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"][target] = 0;
        } else {
          _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"][target] = 1;
        }
    }
  }
  ...
  Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* saveUserSettings */ "e"])();
}

function processPassengers() {
  var paxText = "";
  var e = document.getElementById("numAdults");
  _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].adults = Number(e.options[e.selectedIndex].value);
  e = document.getElementById("numInfantsLap");
  _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].infantsLap = Number(e.options[e.selectedIndex].value);
  e = document.getElementById("numInfantsSeat");
  _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].infantsSeat = Number(e.options[e.selectedIndex].value);
  _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].cAges = new Array();
  for (var i = 1; i <= 8; i++) {
    processChild("child" + i + "age");
  }
  paxText =
    _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].adults +
    "a" +
    (_settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].cAges.length > 0
      ? " " + _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].cAges.length + "c"
      : "") +
    (_settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].infantsLap + _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].infantsSeat > 0
      ? " " +
        (_settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].infantsLap + _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].infantsSeat) +
        "i"
      : "");
...
function processChild(target) {
  ...
  if (tmp >= 2) {
    _settings_paxSettings__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].cAges.push(tmp);
  }
}

function printSettingsvalue(target) {
  if (_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* registeredSettings */ "d"][target]) {
  ...
  switch (target) {
    case "timeformat":
      return _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].timeformat;
    case "language":
      return _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].language;
    case "linkFontsize":
      return _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].linkFontsize.toString();
    case "cabin":
      return _settings_appSettings__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].cabin;
    default:
      return boolToEnabled(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"][target]);
  }
}
...
var map = {
	...
	"./airlines/vs.js": 35,
	"./index.js": 3,
	"./meta/googleFlights.js": 36,
	"./meta/jetcost.js": 37,
	"./meta/kayak.js": 38,
	"./meta/momondo.js": 39,
	"./meta/skyscanner.js": 40,
	"./meta/tripadvisor.js": 41,
	"./otas/cheapoair.js": 42,
	"./otas/edestinos.js": 43,
	"./otas/edreams.js": 44,
	"./otas/etraveli.js": 45,
	"./otas/expedia.js": 46,
	"./otas/flightnetwork.js": 47,
	"./otas/hop2.js": 48,
	"./otas/lucky2go.js": 49,
	"./otas/priceline.js": 50,
	"./otas/travix.js": 51,
	"./other/gcm.js": 52,
	"./other/wheretocredit.js": 53
};
...
function printAS() {
  ...
  var createUrl = function() {
    ...
    url += Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__[/* isOneway */ "e"])() ? "ow" : "rt";
...
function print() {
  ...
  const createUrl = function(edition) {
    ...
    if (Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* isOneway */ "e"])()) {
      url += `&seladate1=&TID=OW`;
    } else if (Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* isRoundtrip */ "f"])()) {
...
function printEY() {
  ...
  var createUrl = function() {
    ...
    let url =
      ...
      Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__[/* getTripType */ "c"])("OW", "RT", "MC");
...
function printIB() {
  ...
  var createUrl = function(edition, currency) {
    ...
    var url =
      ...
      edition[0] +
      "&TripType=" +
      Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* getTripType */ "c"])("OneWay", "RoundTrip", "MultiCity");
...
function printPS() {
  ...
  var createUrl = function(edition, currency) {
    ...
    var url =
      ...
      edition[0] +
      "&TripType=" +
      Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__[/* getTripType */ "c"])("OneWay", "RoundTrip", "MultiCity");
...
function printVS() {
  ...
  var createUrl = function() {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__[/* printNotification */ "i"])("Error: Failed to validate Passengers in printVS");
      return;
    }
    let url =
...
function print() {
  if (Object(_parse_itin__WEBPACK_IMPORTED_MODULE_1__[/* isMulticity */ "d"])()) return; // no multi segments
...
function printCheapOair() {
  ...
  coaUrl += "&tt=" + Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__[/* getTripType */ "c"])("OneWay", "RoundTrip", "MultiCity");
...
function printEtraveli() {
  if (Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__[/* isMulticity */ "d"])()) return; // no multi segments
...
var timezones = __webpack_require__(12);
...
function printAaSabre() {
  ...
  var createUrl = function(edition) {
    ...
    url += (edition || "US") + ",";
    url += Object(itin["e" /* isOneway */])() ? "oneWay" : "multi";
    url +=
      ",4,A" +
      pax.adults +
      "S0C" +
...
// EXTERNAL MODULE: ./src/print/index.js
var print = __webpack_require__(10);

// EXTERNAL MODULE: ./src/print/settings.js
...
function manageState() {
  if (
    !userSettings["a" /* default */].enableMultiSearch ||
    !window.localStorage ||
    !window.history ||
    !XMLHttpRequest ||
...
(async () => {
  ...
  Object(settings["a" /* createUsersettings */])();
  manageState();
  injectCss();
  bindDarkmode();
...
function startScript() {
  ...
  window.addEventListener(
    "hashchange",
    () => {
      if (window.location.hash !== appSettings["a" /* default */].laststatus) {
        pageChanged();
      }
    },
    false
...
function pageChanged() {
  ...
  Object(print["a" /* cleanUp */])();
  setTimeout(function() {
    getPage();
  }, 200);
  appSettings["a" /* default */].laststatus = window.location.hash;
}
