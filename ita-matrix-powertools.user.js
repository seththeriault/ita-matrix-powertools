...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "readItinerary", function() { return readItinerary; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCurrentSegs", function() { return getCurrentSegs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripType", function() { return getTripType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isOneway", function() { return isOneway; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isRoundtrip", function() { return isRoundtrip; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isMulticity", function() { return isMulticity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "currentItin", function() { return currentItin; });
...
function readItinerary() {
  ...
  var legs = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["exRE"])(html, re);
  ...
  var bfs = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["exRE"])(html, re);
  var bf = { c: "", f: "", l: new Array() };
  for (i = 0; i < bfs.length; i += 3) {
    bf.c = bfs[i];
    bf.f = bfs[i + 1];
    farebases.push(bf.f);
    bf.l = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["exRE"])(bfs[i + 2], /(\w\w\w\-\w\w\w)/g);
  ...
  segs = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["exRE"])(html, re);
  ...
  for (i = 0; i < segs.length; i += 15) {
    ...
    const month = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["monthnameToNumber"])(segs[i + 3]);
  ...
  for (var i = 0; i < dirtyFare.length; i++) {
    ...
    if (curfare.length > 1) {
      ...
      if (l == 0) {
        Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Unused fare:" + dirtyFare[i]);
      }
    }
  }
  ...
  milepaxprice = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["exRE"])(html, re);
  // detect currency
...
function parseAddInfo(info) {
  ...
  temp = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["exRE"])(info, re);
  if (temp.length == 2) {
    // Got datechange
    const month = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["monthnameToNumber"])(temp[0]);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleVis", function() { return toggleVis; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clearNotification", function() { return clearNotification; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "printNotification", function() { return printNotification; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "exRE", function() { return exRE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "padChars", function() { return padChars; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "to2digits", function() { return to2digits; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "to4digits", function() { return to4digits; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "to4digitTime", function() { return to4digitTime; });
...
/* harmony import */ var _settings_paxSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
/* harmony import */ var _print_links__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
...
const req = __webpack_require__(24);
...
function register(type, factory) {
  Object(_print_links__WEBPACK_IMPORTED_MODULE_2__["registerLink"])(type, factory);
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "registeredSettings", function() { return registeredSettings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "registerSetting", function() { return registerSetting; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveUserSettings", function() { return saveUserSettings; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadUserSettings", function() { return loadUserSettings; });
/* harmony import */ var _appSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _appSettings__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_appSettings__WEBPACK_IMPORTED_MODULE_0__);
...
exports.getForcedCabin = exports.getCabin = exports.getCabinFromITA = exports.reset = void 0;
...
function reset() {
    ...
    // reset pax and cabin
    var search = JSON.parse(window.localStorage["savedSearch.0"] || "{}");
    var x = search[3] || {};
    appSettings.cabin = getCabinFromITA(x[8]);
    document.getElementById("mptcabin").firstElementChild.innerHTML =
        appSettings.cabin;
    var itaPax = x[5] || {};
    var itaAdults = itaPax[1] || 1;
    var itaChildren = itaPax[2] || 0;
    var itaInfantLap = itaPax[3] || 0;
    var itaInfantSeat = itaPax[4] || 0;
    var itaSeniors = itaPax[5] || 0;
    var itaYouths = itaPax[6] || 0;
    ...
    var ages = __spreadArrays(new Array(itaYouths).fill(17), new Array(itaChildren).fill(11));
    for (var i = 1; i <= 8; i++) {
        e = document.getElementById("child" + i + "age");
        e.value = ages[i - 1] || -1;
    }
    settings_1.processPassengers();
    history_1.removeHistory();
}
exports.reset = reset;
...
exports.getCabinFromITA = getCabinFromITA;
...
exports.getForcedCabin = getForcedCabin;
...
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__);
...
function getAmadeusUrl(config) {
  ...
  url +=
    "&CABIN=" +
    cabins[_settings_appSettings__WEBPACK_IMPORTED_MODULE_0___default.a.cabin === "Auto" ? maxcabin : Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getForcedCabin"])()] +
    ""; // push cabin
  return url;
}
...
function getAmadeusTriptype() {
  return Object(_parse_itin__WEBPACK_IMPORTED_MODULE_1__["getTripType"])("O", "R", "M");
}
// **** END AMADEUS ****
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findTargetSetVersion", function() { return findTargetSetVersion; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
function findTargetSetVersion(classSelector, nth) {
  for (let setting of itaSettings) {
    ...
    const target = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["findtarget"])(className, nth);
    if (target) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "printLinksContainer", function() { return printLinksContainer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "printImage", function() { return printImage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSidebarContainer", function() { return getSidebarContainer; });
/* harmony import */ var _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var _settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
/* harmony import */ var _settings_translations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
...
function printLinksContainer() {
  ...
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["findtargets"])("editoritem").length > 0) {
    return;
  }
  ...
  //  S&D powertool items
  const elems = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["findtargets"])("powertoolsitem");
...
function createUrlContainerInline() {
  const target = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["findtarget"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__["default"].resultpage.mcDiv, 1);
  if (!target) return;
...
function createUrlContainer() {
  const target = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["findtarget"])(_settings_itaSettings__WEBPACK_IMPORTED_MODULE_1__["default"].resultpage.milagecontainer, 1);
  if (!target) return;
...
var buildFormatLongFn = __webpack_require__(14);
...
var buildLocalizeFn = __webpack_require__(9);
...
var buildMatchPatternFn = __webpack_require__(18);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/locale/_lib/buildMatchFn/index.js
var buildMatchFn = __webpack_require__(10);
...
var itaSettings_1 = __webpack_require__(8);
var translations_1 = __webpack_require__(11);
var itin_1 = __webpack_require__(0);
var utils_1 = __webpack_require__(1);
var links_1 = __webpack_require__(15);
function render() {
    // Editor mode?
    if (userSettings_1["default"].enableEditormode == 1 &&
        utils_1.findtargets("editoritem").length === 0) {
        utils_1.toggleVis(document.getElementById("mptStartparse"), "inline-block");
        addEditor();
        return;
    }
    else if (utils_1.findtargets("editoritem").length > 0) {
        utils_1.toggleVis(document.getElementById("mptStartparse"));
        removeEditor();
        itin_1.readItinerary();
    }
    bindPageLayout();
    if (userSettings_1["default"].enableFarerules == 1)
        bindRulelinks();
    if (userSettings_1["default"].timeformat == "24h")
        bind24HourTime();
    if (userSettings_1["default"].language !== "en" &&
        translations_1["default"][userSettings_1["default"].language].resultpage !== undefined)
        bindTranslations("resultpage", userSettings_1["default"].language, utils_1.findtarget(itaSettings_1["default"].resultpage.itin, 1).nextElementSibling);
    if (userSettings_1["default"].enablePricebreakdown == 1)
        bindPriceBreakdown();
    if (userSettings_1["default"].enableInlineMode == 1)
        printCPM();
    links_1.printLinksContainer();
    if (userSettings_1["default"].enableSeatguru == 1)
        bindSeatguru();
    if (userSettings_1["default"].enablePlanefinder == 1)
        bindPlanefinder();
    if (userSettings_1["default"].enableWheretocredit == 1)
        bindWheretocredit();
}
...
function cleanUp() {
    ...
    //  S&D powertool items
    var elems = utils_1.findtargets("powertoolsitem");
    for (var i = elems.length - 1; i >= 0; i--) {
        elems[i].parentElement.removeChild(elems[i]);
    }
    // S&D price breakdown
    var pbd = utils_1.findtarget("pricebreakdown", 1);
    if (pbd != undefined)
        pbd.parentElement.removeChild(pbd);
}
exports.cleanUp = cleanUp;
function addEditor() {
    for (var i = 0; i < itin_1.currentItin.itin.length; i++) {
        for (var j = 0; j < itin_1.currentItin.itin[i].seg.length; j++) {
...
function removeEditor() {
    for (var i = 0; i < itin_1.currentItin.itin.length; i++) {
        for (var j = 0; j < itin_1.currentItin.itin[i].seg.length; j++) {
            var target = findItinTarget(i + 1, j + 1, "cabin").firstElementChild
                .firstElementChild;
            var cabin = target.options[target.selectedIndex].value;
            var bc = target.nextElementSibling.value;
            var str = cabin + " (" + bc + ")";
            target.innerHTML = str;
        }
    }
...
function bindPageLayout() {
    utils_1.findtarget(itaSettings_1["default"].resultpage.milagecontainer, 1).setAttribute("rowspan", "10");
    var target = utils_1.findtarget(itaSettings_1["default"].resultpage.htbContainer, 1)
...
function bind24HourTime() {
    ...
    var segs = itin_1.getCurrentSegs();
    if (segs.length > 0) {
        var target = utils_1.findtarget(itaSettings_1["default"].resultpage.itin, 1)
            .nextElementSibling;
...
function bindRulelinks() {
    ...
    var j = 0;
    var t = 1;
    var target = utils_1.findtarget(itaSettings_1["default"].resultpage.rulescontainer, t);
    if (target != undefined) {
        do {
            ...
            i++;
            t++;
            target = utils_1.findtarget(itaSettings_1["default"].resultpage.rulescontainer, t);
...
function bindPriceBreakdown() {
    ...
    var t = 1;
    var target = utils_1.findtarget(itaSettings_1["default"].resultpage.htbLeft, t);
    if (userSettings_1["default"].enableInlineMode == 0) {
        var output = "";
        var count = 0;
    }
    if (target != undefined) {
        do {
            ...
            if (type == 1) {
                ...
                var price = Number(target.nextElementSibling.firstElementChild.innerHTML.replace(/[^\d]/gi, ""));
                if (utils_1.hasClass(target.nextElementSibling, itaSettings_1["default"].resultpage.htbGreyBorder)) {
                    ...
                    if (userSettings_1["default"].enableInlineMode == 1) {
                        ...
                        newtr.innerHTML =
                            '<td class="' +
                                itaSettings_1["default"].resultpage.htbLeft +
                                '"><div class="gwt-Label">Basefare per passenger (' +
                                ((basefares / sum) * 100).toFixed(2).toString() +
                                '%)</div></td><td class="' +
                                itaSettings_1["default"].resultpage.htbGreyBorder +
                                '"><div class="gwt-Label">' +
                                cur +
                                (basefares / 100)
                                    .toFixed(2)
                        ...
                        newtr.innerHTML =
                            '<td class="' +
                                ...
                                '%)</div></td><td class="' +
                                itaSettings_1["default"].resultpage.htbRight +
                                '"><div class="gwt-Label">' +
                                cur +
                                (taxes / 100)
                                    .toFixed(2)
                        ...
                        output +=
                            "<tr><td>" +
                                ...
                                (sum / itin_1.currentItin.dist / 100).toFixed(4).toString() +
                                "</td></tr>";
                        output +=
                    ...
                    itin_1.currentItin.basefares = +(basefares / 100).toFixed(2);
                    itin_1.currentItin.taxes = +(taxes / 100).toFixed(2);
                    itin_1.currentItin.surcharges = +(surcharges / 100).toFixed(2);
                    // reset var
                    basefound = 0;
                    basefares = 0;
                    taxes = 0;
            ...
            t++;
            target = utils_1.findtarget(itaSettings_1["default"].resultpage.htbLeft, t);
        } while (target != undefined);
    }
    if (userSettings_1["default"].enableInlineMode == 0) {
        var printtarget = utils_1.findtarget(itaSettings_1["default"].resultpage.htbContainer, 1)
...
function bindTranslations(page, lang, target) {
    if (translations_1["default"][lang] === undefined) {
        utils_1.printNotification("Error: Translation " + lang + " not found");
        return false;
    }
    if (translations_1["default"][lang][page] === undefined) {
        utils_1.printNotification("Error: Translation " + lang + " not found for page " + page);
        return false;
    }
    for (var i in translations_1["default"][lang][page]) {
        var re = new RegExp(i, "g");
        target.innerHTML = target.innerHTML.replace(re, translations_1["default"][lang][page][i]);
    }
}
function printCPM() {
    document
        .querySelector(".KIR33AB-y-c:nth-of-type(1)")
        .insertAdjacentHTML("beforeend", "<li class=\"powertoolsitem\">" + (Number(itin_1.currentItin.price) / Number(itin_1.currentItin.dist)).toFixed(4) + " cpm</li>");
}
function bindSeatguru() {
    for (var i = 0; i < itin_1.currentItin.itin.length; i++) {
        ...
        for (var j = 0; j < itin_1.currentItin.itin[i].seg.length; j++) {
            ...
            var k = 0;
            // lets have a look if we need to skip segments - Flightnumber has to be the same and it must be just a layover
            while (j + k < itin_1.currentItin.itin[i].seg.length - 1) {
                if (itin_1.currentItin.itin[i].seg[j + k].fnr !=
                    itin_1.currentItin.itin[i].seg[j + k + 1].fnr ||
                    itin_1.currentItin.itin[i].seg[j + k].layoverduration >= 1440)
                    break;
                k++;
            }
            ...
            if (!target) {
                utils_1.printNotification("Error: Could not find target in bindSeatguru");
                return false;
            }
            else {
                var url = "http://www.seatguru.com/findseatmap/findseatmap.php?carrier=" +
                    itin_1.currentItin.itin[i].seg[j].carrier +
                    "&flightno=" +
                    itin_1.currentItin.itin[i].seg[j].fnr +
                    "&date=" +
                    ("0" + itin_1.currentItin.itin[i].seg[j].dep.month).slice(-2) +
                    "%2F" +
                    ("0" + itin_1.currentItin.itin[i].seg[j].dep.day).slice(-2) +
                    "%2F" +
                    itin_1.currentItin.itin[i].seg[j].dep.year +
                    "&to=&from=" +
                    itin_1.currentItin.itin[i].seg[j].orig;
...
function bindPlanefinder() {
    for (var i = 0; i < itin_1.currentItin.itin.length; i++) {
        ...
        for (var j = 0; j < itin_1.currentItin.itin[i].seg.length; j++) {
            ...
            if (!target) {
                utils_1.printNotification("Error: Could not find target in bindPlanefinder");
                return false;
            }
            else {
...
function bindWheretocredit() {
    for (var i = 0; i < itin_1.currentItin.itin.length; i++) {
        ...
        for (var j = 0; j < itin_1.currentItin.itin[i].seg.length; j++) {
            ...
            if (!target) {
                utils_1.printNotification("Error: Could not find target in bindWheretocredit");
                return false;
            }
            else {
                var url = "http://www.wheretocredit.com/" +
                    itin_1.currentItin.itin[i].seg[j].carrier.toLowerCase() +
                    "/" +
                    itin_1.currentItin.itin[i].seg[j].bookingclass.toLowerCase();
                target.children[0].classList.add("pt-textlink");
                target.children[0].innerHTML = target.children[0].innerHTML
                    .replace(/<a.*?\/a>/, "(" + itin_1.currentItin.itin[i].seg[j].bookingclass + ")")
                    .replace("(" + itin_1.currentItin.itin[i].seg[j].bookingclass + ")", '<a href="' +
                    url +
                    '" target="_blank">(' +
                    itin_1.currentItin.itin[i].seg[j].bookingclass +
                    ")</a>");
            }
        }
    }
...
function findItinTarget(leg, seg, tcell) {
    var target = utils_1.findtarget(itaSettings_1["default"].resultpage.itin, 1);
    if (!target) {
        utils_1.printNotification("Error: Itin not found in findItinTarget-function");
        return;
    }
    // go to leg
    var targetLeg = target.nextElementSibling.children[leg - 1];
    if (targetLeg === undefined) {
        utils_1.printNotification("Error: Leg not found in findItinTarget-function");
        return;
    }
    ...
    if (targetSeg.length >= 2) {
        ...
        for (i = 0; i < targetSeg.length; i++) {
            if (utils_1.hasClass(targetSeg[i], itaSettings_1["default"].resultpage.itinRow)) {
                j++;
                if (j >= seg) {
                    index = i;
        ...
        if (i == targetSeg.length) {
            //target not found
            utils_1.printNotification("Error: Call to unreachable Segment in Leg " +
                leg +
        ...
        switch (tcell) {
            ...
            case "cabin":
                ...
                break;
            default:
                utils_1.printNotification("Error: Unknown Target in findItinTarget-function");
                return;
        }
        return targetSeg[index + rowoffset].children[columnoffset];
    }
    else {
        utils_1.printNotification("Error: Unknown error in findItinTarget-function");
        return;
    }
}
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ cloneObject; });
...
exports.__esModule = true;
exports.processPassengers = exports.createUsersettings = void 0;
var appSettings_1 = __webpack_require__(4);
var userSettings_1 = __webpack_require__(3);
var paxSettings_1 = __webpack_require__(13);
var utils_1 = __webpack_require__(1);
...
function createUsersettings() {
    ...
    document.getElementById("settingsVisToggler").onclick = function () {
        utils_1.toggleVis(document.getElementById("mptSettings"));
    };
    document.getElementById("passengerVisToggler").onclick = function () {
        utils_1.toggleVis(document.getElementById("mptPassengers"));
    };
    // Build settings
    ...
    Object.keys(userSettings_1.registeredSettings).forEach(function (setting) {
        str += "<div id=\"mpt" + setting + "\" style=\"width:33%;float:left;\">" + userSettings_1.registeredSettings[setting].name + ": <label style=\"cursor:pointer;\">" + printSettingsvalue(setting) + "</label></div>";
    });
    ...
    if (window.confirm("Are you sure you want to reset any saved settings to the default values? The page will automatically reload to complete the reset.")) {
        (function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(typeof GM === "undefined" || typeof GM.info != "undefined")) return [3 /*break*/, 2];
                        return [4 /*yield*/, userSettings_1.saveUserSettings(null)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
...
function toggleSettings(target) {
    ...
    if (userSettings_1.registeredSettings[target] && userSettings_1.registeredSettings[target].values) {
        var pos = findPositionForValue(userSettings_1["default"][target], userSettings_1.registeredSettings[target].values);
        if (pos >= userSettings_1.registeredSettings[target].values.length - 1 || pos === -1) {
            userSettings_1["default"][target] = userSettings_1.registeredSettings[target].values[0].value;
        }
        else {
            userSettings_1["default"][target] =
                userSettings_1.registeredSettings[target].values[pos + 1].value;
        }
    }
    else {
        switch (target) {
            case "timeformat":
                if (userSettings_1["default"].timeformat == "12h") {
                    userSettings_1["default"].timeformat = "24h";
                }
                else {
                    userSettings_1["default"].timeformat = "12h";
                }
                break;
            case "language":
                if (userSettings_1["default"].language == "de") {
                    userSettings_1["default"].language = "en";
                }
                else {
                    userSettings_1["default"].language = "de";
                }
                break;
            case "linkFontsize":
                if (userSettings_1["default"].linkFontsize <= 190 &&
                    userSettings_1["default"].linkFontsize >= 50) {
                    userSettings_1["default"].linkFontsize += 10;
                }
                else {
                    userSettings_1["default"].linkFontsize = 50;
                }
                break;
            case "cabin":
                if (appSettings_1["default"].cabin === "Auto") {
                    appSettings_1["default"].cabin = "Y";
                }
                else if (appSettings_1["default"].cabin === "Y") {
                    appSettings_1["default"].cabin = "Y+";
                }
                else if (appSettings_1["default"].cabin === "Y+") {
                    appSettings_1["default"].cabin = "C";
                }
                else if (appSettings_1["default"].cabin === "C") {
                    appSettings_1["default"].cabin = "F";
                }
                else if (appSettings_1["default"].cabin === "F") {
                    appSettings_1["default"].cabin = "Auto";
                }
                // refresh links
                links_1.printLinksContainer();
                break;
            default:
                if (userSettings_1["default"][target] == 1) {
                    userSettings_1["default"][target] = 0;
                }
                else {
                    userSettings_1["default"][target] = 1;
                }
        }
    }
    document.getElementById("mpt" + target).firstElementChild.innerHTML = printSettingsvalue(target);
    userSettings_1.saveUserSettings();
}
function processPassengers() {
    var e = document.getElementById("numAdults");
    paxSettings_1["default"].adults = Number(e.options[e.selectedIndex].value);
    e = document.getElementById("numInfantsLap");
    paxSettings_1["default"].infantsLap = Number(e.options[e.selectedIndex].value);
    e = document.getElementById("numInfantsSeat");
    paxSettings_1["default"].infantsSeat = Number(e.options[e.selectedIndex].value);
    paxSettings_1["default"].cAges = new Array();
    for (var i = 1; i <= 8; i++) {
        processChild("child" + i + "age");
    }
    var paxText = paxSettings_1["default"].adults +
        "a" +
        (paxSettings_1["default"].cAges.length > 0
            ? " " + paxSettings_1["default"].cAges.length + "c"
            : "") +
        (paxSettings_1["default"].infantsLap + paxSettings_1["default"].infantsSeat > 0
            ? " " +
                (paxSettings_1["default"].infantsLap + paxSettings_1["default"].infantsSeat) +
                "i"
            : "");
...
function processChild(target) {
    ...
    var tmp = Number(e.options[e.selectedIndex].value);
    if (tmp >= 2) {
        paxSettings_1["default"].cAges.push(tmp);
    }
}
function printSettingsvalue(target) {
    if (userSettings_1.registeredSettings[target]) {
        return findNameForValue(userSettings_1["default"][target], userSettings_1.registeredSettings[target].values);
    }
    switch (target) {
        case "timeformat":
            return userSettings_1["default"].timeformat;
        case "language":
            return userSettings_1["default"].language;
        case "linkFontsize":
            return userSettings_1["default"].linkFontsize.toString();
        case "cabin":
            return appSettings_1["default"].cabin;
        default:
            return boolToEnabled(userSettings_1["default"][target]);
    }
}
...
function findPositionForValue(needle, haystack) {
    return haystack.findIndex(function (o) { return o.value == needle; });
}
...
exports.__esModule = true;
exports.removeHistory = exports.renderHistory = void 0;
var dom_chef_1 = __webpack_require__(65);
var formatDistanceToNow_1 = __webpack_require__(68);
var en_US_1 = __webpack_require__(16);
var de_1 = __webpack_require__(69);
var userSettings_1 = __webpack_require__(3);
var appSettings_1 = __webpack_require__(4);
...
function subscribeSearchChanges() {
    ...
    window.Storage.prototype.setItem = function (key, value) {
        ...
        if (key !== "savedSearch.0")
            return;
        var _a = JSON.parse(value), _ = _a["12"], search = __rest(_a, ["12"]);
        userSettings_1["default"].history = __spreadArrays([
            { ts: new Date().toISOString(), savedSearch: value }
        ], userSettings_1["default"].history.filter(function (h) {
            var _a = JSON.parse(h.savedSearch), _ = _a["12"], hist = __rest(_a, ["12"]);
...
function changeSearch(e, key, savedSearch) {
    if (state_1.stateEnabled())
        return; // stateful URL will handle everything
    state_1.updateCurrentSearch(savedSearch);
    if (e.ctrlKey ||
        e.shiftKey ||
        e.metaKey || // apple
...
function getSearchUrl(obj, key, search) {
    if (state_1.stateEnabled()) {
        return state_1.getStateUrl({ search: search }, getHash(key));
    }
    else {
...
exports.__esModule = true;
exports.getStateUrl = exports.updateCurrentSearch = exports.manageState = exports.stateEnabled = void 0;
var JSONCrush_1 = __webpack_require__(66);
var userSettings_1 = __webpack_require__(3);
function stateEnabled() {
    var _a, _b;
    return (userSettings_1["default"].enableMultiSearch &&
        window.localStorage &&
...
function manageState() {
    ...
    XMLHttpRequest.prototype.open = function (method, url) {
        if ((url || "").toLowerCase().endsWith("/search")) {
            var search_1 = JSON.parse(window.localStorage["savedSearch.0"]);
            saveStateToUrl({ search: search_1 });
            this.addEventListener("load", function () {
                return saveStateToUrl({
                    search: search_1,
...
function loadState() {
    ...
    var savedState = search && search.get("mpt:state");
    if (savedState) {
        var _a = JSON.parse(JSONCrush_1.JSONUncrush(savedState)), search_2 = _a.search, sessionState = _a.sessionState;
        if (search_2)
            updateCurrentSearch(typeof search_2 === "string" ? search_2 : JSON.stringify(search_2));
        if (sessionState)
...
function updateCurrentSearch(search) {
    ...
    var searches = [];
    for (var i = 0; i < len; i++) {
        var savedSearch = window.localStorage["savedSearch." + i];
        if (savedSearch)
            searches.push(savedSearch);
    }
    searches = __spreadArrays([search], searches.filter(function (s) { return s !== search; }));
    for (var i = 0; i < Math.min(len, searches.length); i++) {
        window.localStorage["savedSearch." + i] = searches[i];
    }
}
exports.updateCurrentSearch = updateCurrentSearch;
function getStateUrl(state, hash) {
    ...
    if (state) {
        ...
        search.set("mpt:state", JSONCrush_1.JSONCrush(JSON.stringify(state), 10));
    }
    else
...
function saveStateToUrl(currentState) {
    var url = getStateUrl(currentState, window.location.hash);
...
var map = {
	...
	"./airlines/vs.js": 46,
	"./index.js": 2,
	"./meta/googleFlights.js": 47,
	"./meta/jetcost.js": 48,
	"./meta/kayak.js": 49,
	"./meta/momondo.js": 50,
	"./meta/skyscanner.js": 51,
	"./meta/tripadvisor.js": 52,
	"./otas/cheapoair.js": 53,
	"./otas/edestinos.js": 54,
	"./otas/edreams.js": 55,
	"./otas/etraveli.js": 56,
	"./otas/expedia.js": 57,
	"./otas/flightnetwork.js": 58,
	"./otas/hop2.js": 59,
	"./otas/lucky2go.js": 60,
	"./otas/priceline.js": 61,
	"./otas/travix.js": 62,
	"./other/gcm.js": 63,
	"./other/wheretocredit.js": 64
};
...
function printAA() {
  ...
  var createUrl = function(edition) {
    ...
    var search = "1,,USD0.00," + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.length + ",";
    var legs = new Array();
    var leg = "";
    var segs = new Array();
    var seg = "";
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.length; i++) {
      ...
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg.length; j++) {
        ...
        seg =
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j + k].arr.year +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j + k].arr.month).slice(-2) +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j + k].arr.day).slice(-2) +
          "T" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j + k].arr.time).slice(-5) +
          (typeof _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j + k].arr.offset == "undefined"
            ? "+00:00"
            : _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j + k].arr.offset) +
          ",";
        seg += _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].bookingclass + ",";
        seg +=
          ...
          "T" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.time).slice(-5) +
          (typeof _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.offset == "undefined"
            ? "+00:00"
            : _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.offset) +
          ",";
        seg += _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j + k].dest + ",";
        seg +=
          ...
          ",";
        seg += _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].orig; // NO , here!
        segs.push(seg);
        j += k;
      }
      ...
      leg =
        ...
        ",";
      leg += _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].dest + ",,";
      leg += _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].orig + ","; // USE , here!
      legs.push(leg);
    }
    search += "DIRECT,";
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printAA");
      return;
    }
    ...
    // push outer search
    search += _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.length + "," + legs.join();
  ...
  if (edition.length != 2) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error:Invalid AA-Edition");
    return;
  }
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["registerSetting"])(
...
/* harmony import */ var _settings_translations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1);
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2);
...
function printAC() {
  ...
  var createUrl = function(edition) {
    ...
    acUrl +=
      ...
      "&countryOfResidence=" +
      edition +
      (_settings_appSettings__WEBPACK_IMPORTED_MODULE_0___default.a.itaLanguage == "de" || _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["default"].language == "de"
        ? "&language=de"
        : "&language=en");
    // validate Passengers here: Max Paxcount = 7 (Infs not included) - >11 = Adult - InfSeat = Child
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_3__["printNotification"])("Error: Failed to validate Passengers in printAC");
      return;
    }
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_5__["currentItin"].itin.length; i++) {
      acUrl +=
        "&departure" +
        (i + 1) +
        "=" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_5__["currentItin"].itin[i].dep.day).slice(-2) +
        "/" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_5__["currentItin"].itin[i].dep.month).slice(-2) +
        "/" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_5__["currentItin"].itin[i].dep.year +
        "&org" +
        (i + 1) +
        "=" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_5__["currentItin"].itin[i].orig +
        "&dest" +
        (i + 1) +
        "=" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_5__["currentItin"].itin[i].dest;
    }
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["registerSetting"])("Air Canada", "acEdition", acEditions, "us");
...
function print() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error: Failed to validate Passengers in printAF");
    return;
  }

  const segs = Object(_parse_itin__WEBPACK_IMPORTED_MODULE_4__["getCurrentSegs"])();
  const cabin = cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getCabin"])(Math.max(...segs.map(seg => seg.cabin)))];
    ...
    return (
      ...
      encodeURIComponent(
        `/search/summary?deviationValue=5&connections=${segs
          .map(
            seg =>
              `${seg.orig}:${seg.dep.year}${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to2digits"])(
                seg.dep.month
              )}${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to2digits"])(seg.dep.day)}@${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to4digitTime"])(seg.dep.time24)}:${
                seg.carrier
              }${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to4digits"])(seg.fnr)}:${seg.bookingclass}:${seg.farebase}:${
                cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getCabin"])(seg.cabin)]
              }>${seg.dest}`
          )
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["registerSetting"])("Air France", "afEdition2", editions, "www.airfrance.us");
...
function printAS() {
  ...
  var createUrl = function() {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printAS");
      return;
    }
    var url = "https://www.alaskaair.com/planbook/shoppingstart?";
    url += "A=" + pax.adults + "&C=" + pax.children.length + "&FT=";
    url += Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__["isOneway"])() ? "ow" : "rt";
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length; i++) {
      ...
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg.length; j++) {
        ...
        itinseg += "/" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j].dep.year;
        itinseg += "|" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j].fnr + "|";
        itinseg += _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j].cabin ? "f" : "c";
        url += "&F" + ++k + "=" + encodeURIComponent(itinseg);
      }
    }
    url +=
      "&DEST=" +
      _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[0].seg[_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[0].seg.length - 1].dest;
    url += "&FARE=" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].price + "&frm=cart&META=GOO_CS";
    return url;
  };
  var url = createUrl();
  if (!url) {
...
function printAZ() {
  ...
  var createUrl = function(edition) {
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.length; i++) {
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg.length; j++) {
        ...
        azUrl +=
          ...
          seg +
          "].To=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dest;
        azUrl +=
          "&MetaSearchDestinations[" +
          seg +
          "].DepartureDate=" +
        ...
        azUrl +=
          ...
          seg +
          "].ArrivalDate=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].arr.year +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].arr.month).slice(-2) +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].arr.day).slice(-2) +
          ":" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].arr.time).slice(-5);
        azUrl +=
          "&MetaSearchDestinations[" +
          seg +
          "].Flight=" +
        ...
        azUrl +=
          ...
          seg +
          "].code=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].farebase;
        ...
        azUrl +=
          ...
          seg +
          "].cabinClass=" +
          cabins[_parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].cabin];
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printAZ");
      return false;
    }
    azUrl +=
      "&children_number=" +
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["registerSetting"])("Alitalia", "azEdition", azEditions, "us_en");
...
function printBA() {
  ...
  var createUrl = function(edition, language) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error: Failed to validate Passengers in printBA");
      return false;
    }
    var tmpPax = { c: 0, y: 0 };
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin.length; i++) {
      // walks each leg
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg.length; j++) {
        //walks each segment of leg
        var k = 0;
        // lets have a look if we need to skip segments - fnr has to be the same and it must be just a layover
        while (j + k < _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg.length - 1) {
          if (
            _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j + k].fnr !=
              _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j + k + 1].fnr ||
            _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j + k].layoverduration >= 1440
          )
            break;
          k++;
        }
        url +=
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].dep.day).slice(-2) +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].dep.month).slice(-2) +
          _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].dep.year +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].dep.time.replace(":", "")).slice(
            -4
          );
        url +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].carrier +
          ("000" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].fnr).slice(-4);
        url += cabins[_parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].cabin];
        url +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].orig + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j + k].dest;
        if (_parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin.length == 2 && i == 1) {
          url += "F";
        } else {
          url += "T";
        }
        if (_parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].cabin < mincabin) {
          mincabin = _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].cabin;
        }
        j += k;
      }
    }
    url +=
      "&p=EUR6666.66&e=SL&c=" +
      cabins[_settings_appSettings__WEBPACK_IMPORTED_MODULE_0___default.a.cabin === "Auto" ? mincabin : Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getForcedCabin"])()] +
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["registerSetting"])("British Airways", "baEdition", baEditions, "US");
...
function printCZ() {
  ...
  var createUrl = function(edition) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printCZ");
      return;
    }
    var amadeusConfig = {
      sepcabin: 0,
  ...
  if (edition.length != 2) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error:Invalid CZ-Edition");
    return;
  }
  var url = createUrl(edition);
  if (!url) {
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["registerSetting"])("China Southern", "czEdition", czEditions, "US-GB");
...
function printDL() {
  ...
  var createUrl = function(edition) {
    ...
    let segnum = 0;
    _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.forEach((itin, legnum) => {
      itin.seg.forEach(seg => {
        const hour = seg.dep.time24.split(":")[0];
        const time =
          Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(+hour - (+hour < 12 ? 0 : 12)) + (+hour < 12 ? "A" : "P");
        const values = [
          legnum,
          seg.bookingclass,
          seg.orig,
  ...
  if (edition.length != 2) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error:Invalid Delta-Edition");
    return;
  }
  var url = createUrl(edition);
  if (!url) {
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["registerSetting"])("Delta", "dlEdition", dlEditions, "www_us");
...
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_settings_appSettings__WEBPACK_IMPORTED_MODULE_4__);
...
function print() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printEK");
    return;
  }
  ...
  const createUrl = function(edition) {
    let url = `https://www.emirates.com/sessionhandler.aspx?pageurl=/IBE.aspx&pub=${edition}&j=f&section=IBE&j=t&seldcity1=${
      _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[0].orig
    }&selacity1=${_parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[0].dest}&selddate1=${formatDate(
      _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[0].dep
    )}&seladults=${pax.adults}&selofw=0&selteenager=0&selchildren=${
      pax.children.length
    }&selinfants=${pax.infLap}&selcabinclass=${
      cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_4__["getCabin"])(Math.max(...Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["getCurrentSegs"])().map(seg => seg.cabin)))]
    }&selcabinclass1=${
      cabins[
        Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_4__["getCabin"])(Math.max(..._parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[0].seg.map(seg => seg.cabin)))
      ]
    }&showsearch=false&showTeenager=false&showOFW=false&chkFlexibleDates=false&resultby=0&multiCity=`;
    if (Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["isOneway"])()) {
      url += `&seladate1=&TID=OW`;
    } else if (Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["isRoundtrip"])()) {
      url += `&seladate1=${formatDate(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[1].dep)}&TID=SB`;
    } else {
      ...
      url =
        ...
        _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin
          .map(
            itin =>
              `fromCity=${itin.orig}&toCity=${itin.dest}&classType=${
                cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_4__["getCabin"])(Math.max(...itin.seg.map(seg => seg.cabin)))]
              }&departDay=${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(itin.dep.day)}&departMonth=${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(
                itin.dep.month
              )}&departYear=${
                itin.dep.year
...
function formatDate(date) {
  return `${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(date.day)}-${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["monthnumberToName"])(date.month)}-${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(
    date.year
  )}`;
}

Object(___WEBPACK_IMPORTED_MODULE_2__["register"])("airlines", print);
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["registerSetting"])("Emirates", "ekEdition", editions, "/global/english");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _print_links__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var _parse_itin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _settings_appSettings__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_settings_appSettings__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2);
...
function printEY() {
  ...
  var createUrl = function() {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printEY");
      return;
    }

    let url =
      "https://booking.etihad.com/SSW2010/EYEY/webqtrip.html?journeySpan=" +
      Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__["getTripType"])("OW", "RT", "MC");
    url += `&numAdults=${pax.adults}`;
    url += `&numChildren=${pax.children.length}`;
    url += `&numInfants=${pax.infLap}`;
    url += `&advertisedFare=${_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].price}`;
    url += `&currency=${_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].cur || "USD"}`;
    ...
    _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.forEach((itin, legnum) => {
      itin.seg.forEach(seg => {
        ...
        url += `&ms[${segnum}].departure=${seg.dep.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(
          seg.dep.month
        )}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(seg.dep.day)}T${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to4digitTime"])(seg.dep.time24)}`;
        url += `&ms[${segnum}].arrival=${seg.arr.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(
          seg.arr.month
        )}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(seg.arr.day)}T${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to4digitTime"])(seg.arr.time24)}`;
        url += `&ms[${segnum}].leg=${legnum}`;
        url += `&ms[${segnum}].cbnClass=${cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_3__["getCabin"])(seg.cabin)]}`;
...
Object(_print_links__WEBPACK_IMPORTED_MODULE_1__["registerLink"])("airlines", printEY);
...
function printIB() {
  ...
  var createUrl = function(edition, currency) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printIB");
      return;
    }
    var url =
      ...
      edition[0] +
      "&TripType=" +
      Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["getTripType"])("OneWay", "RoundTrip", "MultiCity");
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.length; i++) {
      ...
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg.length; j++) {
        ...
        url += "&Origin" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].orig;
        url += "&Destination" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j + k].dest;
        url += "&Carrier" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].carrier;
        url +=
          "&DepartureDate" +
          seg +
          "=" +
          ...
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.day).slice(-2);
        url += "&FlightNumber" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].fnr;
        url +=
          "&BookingCode" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].bookingclass;
        url += "&Cabin" + seg + "=" + cabins[_parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].cabin];
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["registerSetting"])("Iberia", "ibEdition", ibEditions, "en-US");
...
function printKL() {
  ...
  var createUrl = function(edition) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error: Failed to validate Passengers in printKL");
      return;
    }
    ...
    url +=
      ...
      segs
        .map(
          seg =>
            `${seg.orig}:${seg.dep.year}${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to2digits"])(seg.dep.month)}${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to2digits"])(
              seg.dep.day
            )}@${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to4digitTime"])(seg.dep.time)}:${seg.carrier}${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to4digits"])(
              seg.fnr
            )}:${seg.bookingclass}>${seg.dest}`
        )
        .join("-");
    url += "&ref=MS,fb=" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].farebases.join(".");
    url += "&numberOfAdults=" + pax.adults;
    url += "&numberOfChildren=" + pax.children.length;
    url += "&numberOfInfants=" + pax.infLap;
    url +=
      "&cabinClass=" +
      cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getCabin"])(Math.min(...segs.map(seg => seg.cabin)))];
  ...
  if (edition.length != 2) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error:Invalid KLM-Edition");
    return;
  }
  var url = createUrl(edition);
  if (!url) {
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["registerSetting"])("KLM", "klEdition", klEditions, "us_en");
...
function printLA() {
  ...
  var createUrl = function(edition) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printLA");
      return;
    }
    ...
    const parameters = {
      ...
      trip: {
        flights: _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.map(itin => {
          return {
            amount: _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].price,
            currency: _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].cur || "USD",
...
function formatDate(date) {
  return `${date.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(date.month)}-${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(date.day)}`;
}

Object(___WEBPACK_IMPORTED_MODULE_2__["register"])("airlines", printLA);
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["registerSetting"])("LATAM", "laEdition", laEditions, "en/us");
...
function printLH() {
  ...
  var createUrl = function(edition) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printLH");
      return false;
    }
    var amadeusConfig = {
      sepcabin: 0,
  ...
  if (edition.length != 2) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error:Invalid Lufthansa-Edition");
    return;
  }
  var url = createUrl(edition);
  if (!url) {
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["registerSetting"])("Lufthansa", "lhEdition", lhEditions, "US-gb");
...
function printLX() {
  ...
  var createUrl = function(edition) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error: Failed to validate Passengers in printLX");
      return;
    }
    //Build multi-city search based on legs
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin.length; i++) {
      // walks each leg
      url +=
        "/" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].orig + "-" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].dest + "/";
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg.length; j++) {
        //walks each segment of leg
        var k = 0;
        // lets have a look if we need to skip segments - Flightnumber has to be the same and it must be just a layover
        ...
        url +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].carrier +
          _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].fnr +
          "-";
        if (_parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].cabin < mincabin) {
          mincabin = _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].cabin;
        }
    ...
    url +=
      ...
      "/infants-" +
      pax.infLap;
    url += cabins[_settings_appSettings__WEBPACK_IMPORTED_MODULE_0___default.a.cabin === "Auto" ? mincabin : Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getForcedCabin"])()];
    return url;
  };
  // get edition
  var edition = _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["default"].lxEdition.split("_");
  if (edition.length != 2) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error:Invalid Swiss-Edition");
    return;
  }
  var url = createUrl(edition);
  if (!url) {
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["registerSetting"])("Swiss", "lxEdition", lxEditions, "us_en");
...
function printOA() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printOA");
    return;
  }
  var paxConfig = { allowinf: 1, youthage: 0 };
  var amadeusConfig = {
...
function print() {
  ...
  const createUrl = function(edition) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers for OS");
      return;
    }
    ...
    const carriers = {};
    const farebases = [];
    _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.forEach((itin, itinnum) => {
      const startDate = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["toDate"])(itin.dep);
      /** @param {Date} endDate */
      const getDays = function(endDate) {
        const days = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["dayDiff"])(startDate, endDate);
        return days ? "+" + days : "";
      };
      ...
      itin.seg.forEach((seg, segnum) => {
        ...
        url += `&day${itinnum}_${segnum}=${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(itin.dep.day)}`;
        url += `&month${itinnum}_${segnum}=${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(itin.dep.month)}`;
        url += `&year${itinnum}_${segnum}=${itin.dep.year}`;
        url +=
          `&deptime${itinnum}_${segnum}=${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to4digitTime"])(seg.dep.time24)}` +
          getDays(Object(_utils__WEBPACK_IMPORTED_MODULE_0__["toDate"])(seg.dep));
        url +=
          `&arrtime${itinnum}_${segnum}=${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to4digitTime"])(seg.arr.time24)}` +
          getDays(Object(_utils__WEBPACK_IMPORTED_MODULE_0__["toDate"])(seg.arr));
        url += `&fn${itinnum}_${segnum}=${seg.carrier}${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to4digits"])(seg.fnr)}`;
        url += `&comp${itinnum}_${segnum}=EC`;

        carriers[seg.carrier] = (carriers[seg.carrier] || 0) + 1;
        farebases.push(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].farebases[itinnum]);
      });
    });
  ...
  var edition = _settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["default"].osEdition;
  if (edition.length != 2) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error:Invalid Austrian-Edition");
    return;
  }
  var url = createUrl(edition);
  if (!url) {
...
Object(___WEBPACK_IMPORTED_MODULE_2__["register"])("airlines", print);
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["registerSetting"])("Austrian", "osEdition", editions, "en");
...
function printPS() {
  ...
  var createUrl = function(edition, currency) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printPS");
      return false;
    }
    var url =
      ...
      edition[0] +
      "&TripType=" +
      Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__["getTripType"])("OneWay", "RoundTrip", "MultiCity");
...
function printQF() {
  ...
  var createUrl = function(edition, currency) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error: Failed to validate Passengers in printQF");
      return false;
    }
    ...
    var tmpTravelDates = "";
    var finalDest = _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[0].seg[0].dest;
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin.length; i++) {
      ...
      if (tmpTravelDates === "" || !tmpTravelDates) {
        tmpTravelDates +=
          _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].dep.year.toString() +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].dep.month).slice(-2).toString() +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].dep.day).slice(-2).toString() +
          "0000";
      } else {
        tmpTravelDates +=
          "%2C" +
      ...
      segDepAirports += _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].orig.toString();
      // Grab the destination airport of each leg:
      if (segDestAirports.length > 14) segDestAirports += "%2C";
      segDestAirports += _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].dest.toString();
      ...
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg.length; j++) {
        ...
        url +=
          ...
          (j + 1) +
          "=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].bookingclass;

        // record the departing and destination airports for this leg:
        // all departing airports:
        if (depAirports.length > 13) depAirports += "%2C";
        depAirports += _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].orig.toString();
        // all destination airports:
        if (destAirports.length > 14) destAirports += "%2C";
        destAirports += _parse_itin__WEBPACK_IMPORTED_MODULE_4__["currentItin"].itin[i].seg[j].dest.toString();
    ...
    urlBase +=
      "&travelClass=" +
      travelClass[_settings_appSettings__WEBPACK_IMPORTED_MODULE_0___default.a.cabin === "Auto" ? mincabin : Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getForcedCabin"])()];
    // Add passenger info:
    urlBase +=
      "&numberOfAdults=" +
      pax.adults +
...
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["registerSetting"])("Qantas", "qfEdition", qfEditions, "EN_US");
Object(_settings_userSettings__WEBPACK_IMPORTED_MODULE_1__["registerSetting"])("Qantas", "qfCurrency", qfCurrencies, "USD");
...
function print() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printQR");
    return;
  }

  const cabin =
    cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_3__["getCabin"])(Math.min(...Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__["getCurrentSegs"])().map(seg => seg.cabin)))];

  const tripType = _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length > 1 ? "M" : "O";

  let url = `https://booking.qatarairways.com/nsp/views/showBooking.action?widget=MLC&selLang=${_settings_appSettings__WEBPACK_IMPORTED_MODULE_3___default.a.itaLanguage}&tripType=${tripType}&bookingClass=${cabin}&adults=${pax.adults}&children=${pax.children.length}&infants=${pax.infLap}&isMetaSearch=true&`;
  url += _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin
    .map((itin, i) => {
      let qs = `fromStation=${itin.orig}&toStation=${itin.dest}&departing=${
        itin.dep.year
      }-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(itin.dep.month)}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(itin.dep.day)}`;
      if (i <= 1)
    ...
    .join("&");
  if (_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length <= 2) url += "&price=0";
  return {
    url,
    title: "Qatar Airways"
  };
...
function printTK() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printTK");
    return;
  }
  var amadeusConfig = {
    sepcabin: 0,
...
function printVS() {
  if (!Object(___WEBPACK_IMPORTED_MODULE_1__["anyCarriers"])("AF", "DL", "KL", "VS")) {
    return;
  }
  ...
  var createUrl = function() {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printVS");
      return;
    }
    let url =
    ...
    url += `&exitCountry=US`;
    url += `&currencyCd=${_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].cur || "USD"}`;
    ...
    _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.forEach((itin, legnum) => {
      itin.seg.forEach(seg => {
        const hour = seg.dep.time24.split(":")[0];
        const time =
          Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(+hour - (+hour < 12 ? 0 : 12)) + (+hour < 12 ? "A" : "P");
        const values = [
          legnum,
          seg.bookingclass,
          seg.orig,
          seg.dest,
          seg.carrier,
          Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to4digits"])(seg.fnr),
          Object(_utils__WEBPACK_IMPORTED_MODULE_0__["monthnumberToName"])(seg.dep.month),
          Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(seg.dep.day),
          seg.dep.year,
          time
        ];
        url += `&itinSegment[${segnum}]=${values.join(":")}`;
...
Object(___WEBPACK_IMPORTED_MODULE_1__["register"])("airlines", printVS);
...
function print() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])(
  ...
  const cabin =
    cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_3__["getCabin"])(Math.min(...Object(_parse_itin__WEBPACK_IMPORTED_MODULE_1__["getCurrentSegs"])().map(seg => seg.cabin)))];

  const url =
    "https://www.google.com/flights/#flt=" +
    _parse_itin__WEBPACK_IMPORTED_MODULE_1__["currentItin"].itin
      .map(
        itin =>
          `${itin.orig}.${itin.dest}.${itin.dep.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to2digits"])(
            itin.dep.month
          )}-${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to2digits"])(itin.dep.day)}.${itin.seg
            .map(
...
function print() {
  if (Object(_parse_itin__WEBPACK_IMPORTED_MODULE_1__["isMulticity"])()) return; // no multi segments
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error: Failed to validate Passengers in printOvago");
    return;
  }
  ...
  var createUrl = function(host) {
    return `${host}?adults=${pax.adults}&children=${
      pax.children.length
    }&infants=${pax.infLap}&cabin_class=${cabin}&${_parse_itin__WEBPACK_IMPORTED_MODULE_1__["currentItin"].itin
      .map(
        (seg, i) =>
...
function formatDate(date) {
  return `${date.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to2digits"])(date.month)}-${Object(_utils__WEBPACK_IMPORTED_MODULE_2__["to2digits"])(date.day)}`;
}
...
function print(method) {
  ...
  const segs = !method ? _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin : Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["getCurrentSegs"])();
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__["printNotification"])("Error: Failed to validate Passengers in printOvago");
    return;
  }

  const cabin =
    cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getCabin"])(Math.min(...Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["getCurrentSegs"])().map(seg => seg.cabin)))];
  ...
  const createUrl = function(host) {
    let url =
      ...
      segs
        .map(
          seg =>
            `${seg.orig}-${seg.dest}/${seg.dep.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_4__["to2digits"])(
              seg.dep.month
            )}-${Object(_utils__WEBPACK_IMPORTED_MODULE_4__["to2digits"])(seg.dep.day)}`
        )
        .join("/");
...
function print(method) {
  ...
  var createUrl = function(market) {
    ...
    url += segs
      .map(
        seg =>
          `${seg.orig}/${seg.dep.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_4__["to2digits"])(seg.dep.month)}-${Object(_utils__WEBPACK_IMPORTED_MODULE_4__["to2digits"])(
            seg.dep.day
          )}/${seg.dest}`
      )
      .join("/");
  ...
  const createUrl = function(host) {
    ...
    url +=
      ...
      segs
        .map(
          (seg, i) =>
            `date${i * 2}=${seg.dep.year}${Object(_utils__WEBPACK_IMPORTED_MODULE_4__["to2digits"])(seg.dep.month)}${Object(_utils__WEBPACK_IMPORTED_MODULE_4__["to2digits"])(
              seg.dep.day
...
function printCheapOair() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_2__["printNotification"])("Error: Failed to validate Passengers in printCheapOair");
    return;
  }
  coaUrl +=
    "&ad=" +
    ...
    pax.infLap;
  coaUrl += "&pos=US";
  coaUrl += "&dispr=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].price;
  var seg = 0;
  var slices = {};
  for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.length; i++) {
    slices[i] = "";
    for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg.length; j++) {
      ...
      coaUrl +=
        ...
        "=" +
        cabins[
          _settings_appSettings__WEBPACK_IMPORTED_MODULE_0___default.a.cabin === "Auto"
            ? _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].cabin
            : Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getForcedCabin"])()
        ];
      coaUrl += "&carr" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].carrier;
      coaUrl +=
        "&dd" +
        seg +
        "=" +
        ...
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.month).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.day).slice(-2);
      coaUrl += "&og" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].orig;
      coaUrl += "&dt" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dest;
      coaUrl += "&fbc" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].bookingclass;
      coaUrl += "&fnum" + seg + "=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].fnr;
    }
    coaUrl += "&Slice" + (i + 1) + "=" + slices[i];
  }

  coaUrl += "&tt=" + Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["getTripType"])("OneWay", "RoundTrip", "MultiCity");
...
function print() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in edestinos");
    return;
  }

  var createUrl = function(host) {
    const cur = _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].cur || "USD";
    let url = `https://${host}/api?PointOfSaleCountry=&UserCurrency=${cur}&DisplayedPrice=${
      _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].price
    }&DisplayedPriceCurrency=${cur}&UserLanguage=${_settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["default"].language ||
      "en"}&TripType=${Object(_parse_itin__WEBPACK_IMPORTED_MODULE_3__["getTripType"])("OneWay", "RoundTrip", "MultiCity")}`;
    url += "&UserLanguage=" + _settings_userSettings__WEBPACK_IMPORTED_MODULE_0__["default"].language || false;
    url += "&Adult=" + pax.adults;
    url += "&Child=" + pax.children.length;
    url += "&InfantLap=" + pax.infLap;

    let j = 0;
    _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.forEach((itin, i) => {
      const slices = [];
      ...
      itin.seg.forEach(seg => {
        ...
        url += `&Cabin${j}=` + cabins[Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_4__["getCabin"])(seg.cabin)];
        ...
        url += `&DepartureDate${j}=${seg.dep.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(
          seg.dep.month
        )}-${Object(_utils__WEBPACK_IMPORTED_MODULE_1__["to2digits"])(seg.dep.day)}`;
...
function printEdreams(title, editions) {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printEdreams");
    return;
  }
  ...
  var createUrl = function(domain) {
    const deeplink = `/results/type=M;${_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin
      .map(
        (itin, i) =>
          `dep${i}=${itin.dep.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(itin.dep.month)}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(
            itin.dep.day
    ...
    const segKeys = _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin
      .map(
        (itin, i) =>
...
function printEtraveli() {
  if (Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__["isMulticity"])()) return; // no multi segments

  var convertDate = function(date, withYear) {
    return (
      ("0" + date.day).slice(-2) +
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["monthnumberToName"])(date.month) +
  ...
  var createUrl = function(host) {
    ...
    ggUrl +=
      ...
      _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[0].dest +
      convertDate(_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[0].dep, false);
    if (_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length > 1)
      ggUrl += convertDate(_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[1].dep, false);
    ggUrl += "/" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].numPax;
    ggUrl +=
      "?selectionKey=" +
      _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin
        .map(function(itin) {
          return itin.seg
            .map(function(seg) {
              return (
...
function printExpedia() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])("Error: Failed to validate Passengers in printExpedia");
    return;
  }
  ...
  let ExpediaCreateUrl = function(expediaBase) {
    ...
    for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin.length; i++) {
      segUrl +=
        "&legs%5B" + i + "%5D.departureAirport=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].orig;
      segUrl +=
        "&legs%5B" + i + "%5D.arrivalAirport=" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].dest;
      segUrl +=
        "&legs%5B" +
        i +
        "%5D.departureDate=" +
        _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].arr.year.toString() +
        "-" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].dep.month).slice(-2) +
        "-" +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].dep.day).slice(-2);
      for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg.length; j++) {
        segUrl += (
          ...
          j +
          "%5D=" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.year.toString() +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.month).slice(-2) +
          "-" +
          ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].dep.day).slice(-2) +
          "-" +
          expediaClasses[
            _settings_appSettings__WEBPACK_IMPORTED_MODULE_0___default.a.cabin === "Auto" ? minCabin : Object(_settings_appSettings__WEBPACK_IMPORTED_MODULE_0__["getForcedCabin"])()
          ] +
          "-" +
          _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].itin[i].seg[j].orig +
          "-" +
...
function printFN() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printFN");
    return;
  }

  const createUrl = function(edition) {
    const tty = _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length === 2 ? 1 : 0;
    let search = `cref=fnbwmint&tty=${tty}&curr=${_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].cur ||
      "USD"}&nativecurr=${_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].cur || "USD"}&cls=0&adt=${
      pax.adults
    ...
    let segCount = 0;
    search += _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin
      .map((leg, i) => {
        const key = _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length === 2 && i === 1 ? "ib" : "ob";
        const legNum = _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length > 2 ? 0 : i;
        return leg.seg
          .map((seg, j) => {
            const segNum = _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length > 2 ? segCount++ : j;
...
function formatDate(date) {
  return (
    "" +
    date.year +
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(date.month) +
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(date.day) +
    date.time24.replace(":", "")
  );
}
...
function print() {
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printHop2");
    return;
  }
  ...
  const segs = Object(_parse_itin__WEBPACK_IMPORTED_MODULE_2__["getCurrentSegs"])();
  const search = `OSKDCR*${cabin}${pax.adults}${pax.children.length}${
    pax.infSeat
  }0/${_parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin
    .map(
      itin =>
        itin.orig +
        itin.dest +
        `${itin.dep.year}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(itin.dep.month)}-${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["to2digits"])(
          itin.dep.day
        )}`
    )
...
function printLucky2go() {
  var createUrl = function(edition) {
    ...
    if (!pax) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["printNotification"])(
    ...
    var url =
      ...
      edition.country +
      "&UserCurrency=" +
      (_parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].cur || "USD") +
      "&DisplayedPrice=" +
      _parse_itin__WEBPACK_IMPORTED_MODULE_3__["currentItin"].price +
...
function printPriceline() {
  ...
  for (var i = 0; i < _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin.length; i++) {
    ...
    pricelineurl += "/" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].orig;
    pricelineurl += "-" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].dest;
    pricelineurl +=
      "-" +
    ...
    for (var j = 0; j < _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg.length; j++) {
      ...
      searchparam += _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j].orig;
      searchparam +=
        _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j].dep.year.toString() +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j].dep.month).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j].dep.day).slice(-2) +
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j].dep.time.replace(":", "")).slice(-4);
      searchparam += _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j + k].dest;
      searchparam +=
        _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j + k].arr.year.toString() +
        ...
        ("0" + _parse_itin__WEBPACK_IMPORTED_MODULE_2__["currentItin"].itin[i].seg[j + k].arr.time.replace(":", "")).slice(
          -4
        );
      searchparam +=
  ...
  if (!pax) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["printNotification"])("Error: Failed to validate Passengers in printPriceline");
    return;
  }
...
function printWheretocredit() {
  return {
    url:
      ...
      Object(_parse_itin__WEBPACK_IMPORTED_MODULE_0__["getCurrentSegs"])()
        .map(seg =>
...
var userSettings = __webpack_require__(3);

// EXTERNAL MODULE: ./src/utils.js
var utils = __webpack_require__(1);

// EXTERNAL MODULE: ./src/links/index.js
var links = __webpack_require__(2);
...
var cloneObject = __webpack_require__(19);
...
var en_US = __webpack_require__(16);
...
var getTimezoneOffsetInMilliseconds = __webpack_require__(12);
...
function toDate_toDate(argument, dirtyOptions) {
  ...
  if (date) {
    ...
    if (dateStrings.timezone || options.timeZone) {
      ...
      offset = Object(getTimezoneOffsetInMilliseconds["a" /* default */])(
...
function zonedTimeToUtc(date, timeZone, options) {
  ...
  var extendedOptions = Object(cloneObject["a" /* default */])(options)
  extendedOptions.timeZone = timeZone
  return toDate_toDate(date, extendedOptions)
}

// EXTERNAL MODULE: ./src/json/timezones.json
var timezones = __webpack_require__(23);
...
function printAaSabre() {
  ...
  var createUrl = function(edition) {
    ...
    if (!pax) {
      Object(utils["printNotification"])("Error: Failed to validate Passengers in printAaSabre");
      return false;
    }
    var url = "https://www.aa.com/goto/metasearch?ITEN=GOOGLE,0,";
    url += (edition || "US") + ",";
    url += Object(itin["isOneway"])() ? "oneWay" : "multi";
    url +=
      ",4,A" +
      pax.adults +
      "S0C" +
...
Object(userSettings["registerSetting"])(
  "American (America & UK)",
  "aaSabreEdition",
  aaSabreEditions,
  "US"
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ formatDistanceToNow; });
...
function formatDistance(dirtyDate, dirtyBaseDate, dirtyOptions) {
  ...
  var localizeOptions = Object(cloneObject["a" /* default */])(options);
...
/* harmony default export */ var de = __webpack_exports__["default"] = (locale);
...
var appSettings_default = /*#__PURE__*/__webpack_require__.n(appSettings);

// EXTERNAL MODULE: ./src/settings/userSettings.js
var userSettings = __webpack_require__(3);

// EXTERNAL MODULE: ./src/settings/itaSettings.js
var itaSettings = __webpack_require__(8);
...
// EXTERNAL MODULE: ./src/print/history.tsx
var print_history = __webpack_require__(21);
...
(async () => {
  await Object(userSettings["loadUserSettings"])();
  Object(settings["createUsersettings"])();
  Object(state["manageState"])();
  injectCss();
  bindDarkmode();
...
function startScript() {
  ...
  window.addEventListener(
    "hashchange",
    () => {
      if (window.location.hash !== appSettings_default.a.laststatus) {
        pageChanged();
      }
    },
    false
...
function pageChanged() {
  Object(appSettings["reset"])();
  Object(print["cleanUp"])();
  setTimeout(function() {
    getPage();
  }, 200);
  appSettings_default.a.laststatus = window.location.hash;
}
...
function startPage() {
  // try to get content
  if (!Object(itaSettings["findTargetSetVersion"])(settings => settings.startpage.maindiv, 1)) {
    Object(utils["printNotification"])("Error: Unable to find content on start page.");
    return false;
  } else {
    Object(print_history["renderHistory"])();
    fixSearchTab();
    // apply style-fix
    const target = Object(utils["findtarget"])(itaSettings["default"].startpage.maindiv, 1);
...
function resultPage() {
  // try to get content
  const itin = Object(itaSettings["findTargetSetVersion"])(settings => settings.resultpage.itin, 1);
  if (!itin) {
    Object(utils["printNotification"])("Error: Unable to find Content on result page.");
    return false;
  }
  // retry if itin not loaded
  if (itin.parentElement.previousElementSibling.style.display != "none") {
    appSettings_default.a.retrycount++;
    if (appSettings_default.a.retrycount > 50) {
      Object(utils["printNotification"])(
  ...
  for (let i in itaSettings["default"].resultpage) {
    if (Object(utils["findtarget"])(itaSettings["default"].resultpage[i], 1) === undefined) {
      Object(utils["printNotification"])(
  ...
  Object(parse_itin["readItinerary"])();
  Object(print["render"])();
}
