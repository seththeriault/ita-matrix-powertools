...
function renderHistoryContainer() {
    const container = (dom_chef.createElement("div", { style: {
        ...
        dom_chef.createElement("p", null, "History")));
    document.body.classList.add("show-history");
    document.body.append(container);
    (async function () {
        let lastDistance;
        let t0 = performance.now();
        await userSettings.default.history.sort((a, b) => new Date(b.ts).getTime() - new Date(a.ts).getTime())
            .reduce(async (last, h) => {
            await last;
...
function toDate_toDate(argument, dirtyOptions) {
  ...
  if (date) {
    ...
    if (dateStrings.timezone || options.timeZone) {
      ...
      offset = (0,getTimezoneOffsetInMilliseconds.default)(
...
// EXTERNAL MODULE: ./src/state/index.ts + 1 modules
var state = __webpack_require__("./src/state/index.ts");
// EXTERNAL MODULE: ./src/print/history.tsx + 14 modules
